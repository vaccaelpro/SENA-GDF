...
<div class="sidebar d-flex flex-column p-3">
  ...
  <div class="menu-container flex-grow-1 d-flex flex-column justify-content-center">
    <div class="menu-item">
      <a href="#"><i class="bi bi-newspaper" id="icn">&nbsp;</i>Novedades</a>
    </div>
    <div class="menu-item">
...
<div class="main-content">
    <section class=formulario-monto>
        ...
        <div class="formulario">
          ...
          <input type="text" placeholder="Ingresar Nombre" style="font-size: 17px;">
  ...
  <option value="ahorro3">Ahorro 3</option>
          ...
          <a href="metas _de _ahorro.html"><button class="btn-añadir">Añadir</button></a>
        </div>
      </section>
</div>
