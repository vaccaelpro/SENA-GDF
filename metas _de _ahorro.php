    ...
    <section class="contenido">
        ...
        <div class="grid">
            <div class="card">
                ...
                <div class="botones">
                    <a href="editar.html" class="btn edit"><i class="bi bi-pencil-fill"></i> Editar</a>
            ...
            <div class="card añadir">
                <a href="agregar_meta.html" class="añadir-btn"><i class="bi bi-plus-circle"></i> Agregar meta</a>
                <a href="agregar_monto.html" class="añadir-btn"><i class="bi bi-plus-circle"></i> Agregar Monto</a>
            </div>
        </div>
    </section>
</div>
